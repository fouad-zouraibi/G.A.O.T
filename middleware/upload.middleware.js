...
//  ****************************************************************
//  ********************** Produit Upload image  **********************
//  ****************************************************************

// Set image storage path
storageProduit= multer.diskStorage({
  destination: (req,file,cb)=>{
  let nameFolder = "/"+moment().format('MMMM')+moment().format('YYYY') ;
  let path = "public/images/produits" ;
...
module.exports.uploadProduit = multer({ storage: storageProduit , fileFilter : fileFilter});
